...
SENSOR_DESCRIPTIONS = [
    ...
    {"name": "DucoBox temp aanzuiging vers", "unique_id": "ducobox_temp_oda", "unit": TEMP_CELSIUS, "url": DUCOBOX_BOXINFO, "path": ["EnergyInfo", "TempODA"], "scale": 0.1, "device_class": SensorDeviceClass.TEMPERATURE},
    {"name": "DucoBox temp aanvoer woning", "unique_id": "ducobox_temp_sup", "unit": TEMP_CELSIUS, "url": DUCOBOX_BOXINFO, "path": ["EnergyInfo", "TempSUP"], "scale": 0.1, "device_class": SensorDeviceClass.TEMPERATURE},
    {"name": "DucoBox temp afzuiging woning", "unique_id": "ducobox_temp_eta", "unit": TEMP_CELSIUS, "url": DUCOBOX_BOXINFO, "path": ["EnergyInfo", "TempETA"], "scale": 0.1, "device_class": SensorDeviceClass.TEMPERATURE},
    {"name": "DucoBox temp afvoer", "unique_id": "ducobox_temp_eha", "unit": TEMP_CELSIUS, "url": DUCOBOX_BOXINFO, "path": ["EnergyInfo", "TempEHA"], "scale": 0.1, "device_class": SensorDeviceClass.TEMPERATURE},
    ...
    # --- Node 2 ---
    {"name": "Duco node 2 Badkamer Temp", "unique_id": "duco_node2_temp", "unit": TEMP_CELSIUS, "url": DUCO_NODE2, "path": ["temp"], "device_class": SensorDeviceClass.TEMPERATURE},
    ...
    # --- Node 3 ---
    {"name": "Duco node 3 Slaapkamer Temp", "unique_id": "duco_node3_temp", "unit": TEMP_CELSIUS, "url": DUCO_NODE3, "path": ["temp"], "device_class": SensorDeviceClass.TEMPERATURE},
    ...
    # --- Node 4 ---
    {"name": "Duco node 4 Woonkamer Temp", "unique_id": "duco_node4_temp", "unit": TEMP_CELSIUS, "url": DUCO_NODE4, "path": ["temp"], "device_class": SensorDeviceClass.TEMPERATURE},
...
class DucoBoxSensor(SensorEntity):
    ...
    def __init__(self, session, name, unique_id, unit, url, path, scale=1.0, device_class=None):
